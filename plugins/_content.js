...
import fs from "fs";
const { generateWAMessageFromContent, prepareWAMessageMedia, proto } =
...
handler.before = async function (m, { conn }) {
  ...
  // Imágenes locales
  global.imagen1 = fs.readFileSync("./storage/img/logo_nina.jpg");
  ...
  global.canalNombre = [
    "𑁯🥢ᰰᩧ ְ  Ботон  💫ִ ᡣ𐭩᷼ ֺ Ботон  💫֔  𔖮𔖰 ִ",
    "Ботон  💫 ",
    "Ботон  💫",
    "Ботон  💫",
    "Ботон  💫",
